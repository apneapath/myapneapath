                        ...
                        $('#referral-list').append(`
                            <tr>
                                ...
                                <td>
                                    ...
                                    ${canView ? `<a title="View referral details" href="/referral-dashboard/${referral.id}" class="btn btn-sm"><span style="color: Dodgerblue;"><i class="fa-solid fa-eye"></i></span></a>` : ''}
