    ...
    <body class="font-sans antialiased">
        ...
        <header id="header" class="header sticky-top">
            ...
            <div class="topbar d-flex align-items-center">
              <div class="container-fluid p-5 d-flex justify-content-center justify-content-md-between">
            ...
            <div class="branding d-flex align-items-center">
              ...
              <div class="container-fluid ps-5 pt-0 pe-5 pb-0 position-relative d-flex align-items-center justify-content-between">
